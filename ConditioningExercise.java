...
/**
 * A class representing conditioning exercises
 */

public class ConditioningExercise extends Exercise {
    private int reps;
    private int sets;
    /**
     ...
     */
    public ConditioningExercise(int id, String name, ArrayList<com.johnjacksonryan.exercise.ExerciseManager.MuscleGroup> muscle,
                                 boolean superSet, boolean dropSet, boolean specialRep,
                                ArrayList<ArrayList<String>> equipment, int reps, int sets, int duration, ArrayList<Integer> difficulty, String notes){
