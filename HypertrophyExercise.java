...
/**
 * A class representing hypertrophy exercises
 */

public class HypertrophyExercise extends Exercise {
    private int reps;
    private int sets;
     ...
     */
    public HypertrophyExercise(int id, String name, ArrayList<com.johnjacksonryan.exercise.ExerciseManager.MuscleGroup> muscle,
